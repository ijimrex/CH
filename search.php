				...
				echo "<script language='javascript'> 
					...
					function addPics(var1){			
								...
								for(var j=0;j<aUrl[var1].length;j++){	
									str+='<a href=\"https://graph.facebook.com/v2.8/'+aid[var1][j]+'/picture?access_token=EAAaKv7Esg68BAKvdA2GOIHxfutua0dL6qZBZAZCLSgB0Fz1dXidLTmOBJOjDb2Bda9d70v1vFnMnvZBEgAum52iGVBJkjlzI0EdU7ZAcjhFZCeFfjyFMV1SyLxMdGHnq3sPao63VYfEOutfmAXtUk71zllLxhpS7QZD\" target=_blank><img width=130 height=130 src='+aUrl[var1][j]+'></img><a> '
